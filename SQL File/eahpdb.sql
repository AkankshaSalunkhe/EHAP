...
--  `DriverName` varchar(120) DEFAULT NULL,
--  `UserName` varchar(120) DEFAULT NULL,
--  `MobileNumber` bigint(10) DEFAULT NULL,
--  `Email` varchar(120) DEFAULT NULL,
--  `Password` varchar(120) DEFAULT NULL,
...
--
--INSERT INTO `tbldriver` (`ID`, `DriverName`, `UserName`, `MobileNumber`, `Email`, `Password`, `DriverRegdate`) VALUES
--(1, 'Driver', 'driver', 7654321980, 'driver@gmail.com', MD5('Test@123'), '2024-01-10 08:56:46');
...
-- Dumping data for table `tbldriver`
--
INSERT INTO `drivers` (`id`, `name`, `email`, `password`, `phone`, `status`) VALUES
(1, 'Driver', 'driver@gmail.com', MD5('Test@123'), '7896541236', 'available');
